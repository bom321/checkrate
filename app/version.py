...
# 1.1.3 = /bank/{code} ช่วงแท็บเล็ต: ตัวเลข KPI/หัวการ์ด/แถวผลิตภัณฑ์ที่ยืมคลาสมาจากหน้าภาพรวม และ
#         ข้อความในกราฟ SVG ย่อตามบันไดขนาดตัวอักษรของหน้าแล้ว (เดิมค้างขนาดเดสก์ท็อปจนดูโดด)
# 1.1.4 = log บอกได้แล้วว่าปัญหาเกิดกับประกาศฉบับไหน: ทุกบรรทัดมีแท็ก [CODE] [YYYY-MM-DD] + สรุปท้ายรอบ
#         ว่าฉบับไหนอ่านไม่ครบ (ทุกธนาคาร) · BBL: ตัดเสียงรบกวนจากการไล่ OCR variant ออกจากระดับ ERROR
#         และปฏิเสธค่าที่ OCR อ่านหลักเกิน/หลุดหาย (>5.00 หรือ 0.00) กู้ประกาศ 30 ก.ค. 2568 ได้เอง
# 1.1.5 = responsive ทั้งเว็บ (ตรวจ 190 เคส = 10 หน้า × 19 ขนาดจอ ด้วย WebKit): กัน Safari บน iOS
#         ขยายตัวอักษรเองตอนหมุนแนวนอน (-webkit-text-size-adjust) · footer ไม่จมใต้แถบเมนูล่างอีก
